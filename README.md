...
- [押し出しパターン１]オブジェクト①をマウスドラッグで移動してオブジェクト②に衝突させると押し出しが発生します
    - オブジェクト①とオブジェクト②のchild要素の値が同じ`gr3`のため押し出しが発生します。
- [押し出しパターン２]オブジェクト①をマウスドラッグで移動してオブジェクト③に衝突させると押し出しが発生します
    - オブジェクト①の`child-layers`にオブジェクト③のグループ gr2 を設定しているため衝突が発生します。
- [押し出しパターン３]オブジェクト③をマウスドラッグで移動してオブジェクト①に衝突させると押し出しが発生しません
    - [押し出しパターン２]と移動するオブジェクトと衝突するオブジェクトが反対のパターンです。
    - オブジェクト③のchild-layersにオブジェクト③のグループ gr2 が設定していないため衝突が発生しません。
- [押し出しパターン４]オブジェクト②をマウスドラッグで移動してオブジェクト③に衝突させると押し出しが発生しません
    - オブジェクト②のchild-layersにオブジェクト③のグループ gr2 が設定していないため衝突が発生しません。
- [移動パターン１]オブジェクト③がオブジェクト①の中にある場合に、オブジェクト①をマウスドラッグで移動するとオブジェクト③も移動する
...
- [移動パターン２]オブジェクト③がオブジェクト②の中にある場合に、オブジェクト②をマウスドラッグで移動してもオブジェクト③は移動しない
